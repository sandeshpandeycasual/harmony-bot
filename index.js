  ...
  if (message.content.match(prefixMention)) {
    ...
    let embed = new MessageEmbed()
      ...
      .setDescription(`Hey **${message.author.username},** I was made by <@${developerID}> 
        ...
        Owners Youtube channel Have you subscribed it ? [Click Here To subscribe](https://youtube.com/LonelyCoders) to join server
        `)
...
require('http').createServer((req, res) => res.end(`okay I am Online`)).listen(3000)
...
// For Watching Status
client.on("ready", () => {
  client.user.setActivity(`music for non-homos`, {
    type: "STREAMING",
