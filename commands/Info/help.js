...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    .setTitle(`${bot} Help`)
    .setDescription(`Hody Here is My help pannel Click below Buttons to see commands`)
    .setImage("https://images-ext-1.discordapp.net/external/lghhbC9rBQZi9C7OEQoYL6v66n_H-D9FzD7Hyw95jfw/https/c.tenor.com/fUKq6NZvwk8AAAAC/riina-headphones.gif")
